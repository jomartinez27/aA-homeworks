...
describe Dessert do
  subject(:brownie) { Dessert.new('brownie', 25, chef)}
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("John Smith")
      expect(brownie.serve).to eq("John Smith has made 25 brownies!")
    end
  end
